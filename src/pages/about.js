    ...
    <SubpageWrapper>
      <MainColumn>
        ...
        <p>
          ...
          , etc. Our findings led us to our purpose: to support local, Organic, recycled, charity based, healthy, and/or other sustainably focused products to build a more sustainable and forward thinking food economy.
        </p>
      </MainColumn>
      <SideColumn>
        <Contact />
